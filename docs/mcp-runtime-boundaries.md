...
| Restrict runtime to read-only validation paths | Command Center policy engine classification check using `config/agent-runtime.json` | Policy decision log with action classification |
