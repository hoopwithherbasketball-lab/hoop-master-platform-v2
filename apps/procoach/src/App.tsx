        ...
        <div className="min-h-screen bg-navy-900 text-white">
          <main className="mx-auto max-w-5xl px-6 py-16">
            <div className="space-y-6 text-center">
              <p className="text-sm uppercase tracking-[0.4em] text-royal-400">ProCoach Platform</p>
              <h1 className="text-4xl font-display font-bold text-white">Elite coaching and tournament operations for girls basketball.</h1>
              <p className="mx-auto max-w-2xl text-slate-400">Run events, share video resources, and support coaches with a modern platform built for pro-level player development.</p>
            ...
            <div className="mt-14 grid gap-6 md:grid-cols-3">
              {features.map((feature) => (
                <div key={feature.title} className="card p-6 space-y-4">
                  ...
                  <Link to={feature.href} className="text-royal-400 font-semibold">Learn more</Link>
                </div>
              ))}
            </div>
