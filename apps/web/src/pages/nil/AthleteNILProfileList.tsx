...
export default function AthleteNILProfileList() {
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <header>
        <h1 className="text-2xl font-bold text-white">Athlete NIL Profiles</h1>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[
          ...
          <div key={i} className="bg-navy-800 border border-white/10 rounded-lg p-5 hover:border-royal-300 transition-colors">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div><p className="font-bold text-white text-sm">{a.name}</p><p className="text-[11px] text-slate-400">{a.pos} | Class of {a.classYr}</p></div>
            </div>
