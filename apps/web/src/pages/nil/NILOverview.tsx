    ...
    <DashboardLayout variant="admin" title="NIL Overview" subtitle="Monitor athlete NIL readiness, brand matches, and outreach." >
      ...
      <div className="card p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold text-navy-900">Brand Readiness</h2>
            <p className="text-slate-500">Current athletes ready for sponsorship outreach.</p>
          </div>
          <StatusBadge status="complete" />
        </div>
        <div className="grid gap-3 sm:grid-cols-3">
          <div className="rounded-3xl bg-slate-50 p-4"><p className="text-xs uppercase text-slate-400">Campaigns</p><p className="text-lg font-semibold text-navy-900">14</p></div>
          <div className="rounded-3xl bg-slate-50 p-4"><p className="text-xs uppercase text-slate-400">Active Partners</p><p className="text-lg font-semibold text-navy-900">7</p></div>
          <div className="rounded-3xl bg-slate-50 p-4"><p className="text-xs uppercase text-slate-400">Response Rate</p><p className="text-lg font-semibold text-navy-900">82%</p></div>
        </div>
      </div>
    </DashboardLayout>
  )
