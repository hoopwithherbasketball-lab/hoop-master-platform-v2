      ...
      <div className="card p-6 space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-3xl bg-slate-50 p-5">
            ...
            <p className="mt-2 text-base font-semibold text-navy-900">Recruiting Profile Update</p>
          </div>
          <div className="rounded-3xl bg-slate-50 p-5">
            <p className="text-xs uppercase tracking-[0.2em] text-slate-400">Priority</p>
            <p className="mt-2 text-base font-semibold text-navy-900">Highlight reel delivery</p>
          </div>
        </div>
        <div className="grid gap-3">
          <label className="block text-sm text-slate-700">Additional details</label>
          <textarea className="w-full min-h-[140px] rounded-3xl border border-slate-200 p-4 text-sm text-slate-900" defaultValue="I need help finalizing my highlight footage and sending it to target schools." />
        </div>
