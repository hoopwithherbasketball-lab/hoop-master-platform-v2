    ...
    <PageShell title="Events & Showcases" description="Upcoming events, camps, and showcases for elite girls basketball players." badge="Events">
      <div className="grid gap-6 md:grid-cols-2">
        {events.map(event => {
          ...
          return (
            <div key={event.id} className={`bg-navy-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border-l-4 ${registered ? 'border-green-500' : 'border-[#0134BD]'}`}>
