...
| Config | Agents must not modify turbo.json, package.json workspace roots, lockfiles, .github/workflows, or Cloudflare config without explicit authorization (e.g., via agent-config-auth label) | CI check / PR Review |
