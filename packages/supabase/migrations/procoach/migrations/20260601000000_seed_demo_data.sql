...
INSERT INTO training_videos (title, description, category, level, duration_minutes, thumbnail_url, video_url, lesson_count) VALUES
  ...
  ('Triple Threat Position Mastery', 'Master the triple threat position — jab steps, shot fakes, and first step explosion', 'skill', 'beginner', 20, 'https://placehold.co/640x360/0134BD/ffffff?text=Triple+Threat', 'https://storage.example.com/training/triple-threat.mp4', 5),
  ('Pick and Roll Reads', 'Advanced pick and roll reads for guards — short roll, pocket pass, and reject', 'film', 'advanced', 50, 'https://placehold.co/640x360/0134BD/ffffff?text=PnR+Reads', 'https://storage.example.com/training/pnr-reads.mp4', 9)
ON CONFLICT DO NOTHING;
