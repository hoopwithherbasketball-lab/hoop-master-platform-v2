...
export const PageShell: React.FC<PageShellProps> = ({
  ...
  return (
    <main
      className={`max-w-6xl mx-auto py-8 sm:py-10 px-4 sm:px-6 lg:px-8 space-y-8 ${className}`}
      aria-labelledby={pageHeadingId}
    >
      <header className="space-y-3">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 id={pageHeadingId} className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-white leading-tight">{title}</h1>
