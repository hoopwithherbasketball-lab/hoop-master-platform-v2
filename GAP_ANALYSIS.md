...
| Prompt packs | BUILT | `prompt-packs/01_bootstrap_target_docs.prompt.md` .. `prompt-packs/11_phase_11_evaluations.prompt.md` | Add per-phase acceptance test templates | Phase 2+ execution |
