...
INSERT INTO training_videos (title, description, category, level, duration_minutes, thumbnail_url, video_url, lesson_count) VALUES
  ...
  ('Post Moves for Guards', 'Unorthodox post moves that give guards an advantage in mismatches', 'skill', 'intermediate', 40, 'https://placehold.co/640x360/0134BD/ffffff?text=Post+Moves', 'https://storage.example.com/training/post-moves-guards.mp4', 5),
  ('Game Film Breakdown: Point Guard Reads', 'Learn to read defenses like a D1 point guard with real game film analysis', 'film', 'advanced', 55, 'https://placehold.co/640x360/0134BD/ffffff?text=Film+Study', 'https://storage.example.com/training/pg-reads.mp4', 10),
  ('Conditioning for Basketball', 'Sport-specific conditioning program to build stamina for the full 32 minutes', 'strength', 'beginner', 25, 'https://placehold.co/640x360/0134BD/ffffff?text=Conditioning', 'https://storage.example.com/training/conditioning.mp4', 4),
  ('Triple Threat Position Mastery', 'Master the triple threat position â€” jab steps, shot fakes, and first step explosion', 'skill', 'beginner', 20, 'https://placehold.co/640x360/0134BD/ffffff?text=Triple+Threat', 'https://storage.example.com/training/triple-threat.mp4', 5),
  ('Pick and Roll Reads', 'Advanced pick and roll reads for guards â€” short roll, pocket pass, and reject', 'film', 'advanced', 50, 'https://placehold.co/640x360/0134BD/ffffff?text=PnR+Reads', 'https://storage.example.com/training/pnr-reads.mp4', 9)
ON CONFLICT DO NOTHING;
